<template>
    <transition name="fade">
        <div id="menu-add-admin-modal" v-if="visible" class="add-admin-modal-wrapper">
            <div class="modal-back" @click="hideAddMenuAdminModal"/>
            <div class="add-modal-box">
                <div class="modal-close" @click="$emit('update:visible', !visible)">{{propShowmodal}}&times;</div>
                <v-form>
                <v-text-field
                    v-model="name"
                    :counter="100"
...
export default {
    ...
    methods: {
        ...
        hideAddMenuAdminModal() {
            console.log('hideaddmenu 호출됨')
